...
class SignMessages with ChangeNotifier {
  SignMessages({
    this.emailOrUsernameHint = defaultEmailOrUsernameHint,
  ...
  static const defaultEmailOrUsernameHint = 'Email or Username';
  ...
  /// Hint text of the email or username [TextField]
  final String emailOrUsernameHint;
