...
import 'src/providers/sign_messages.dart';
import 'src/providers/sign_theme.dart';
...
class FlutSign extends StatefulWidget {
  FlutSign(
      {Key? key,
  ...
  @override
  _FlutSignState createState() => _FlutSignState();
}

class _FlutSignState extends State<FlutSign> with TickerProviderStateMixin {
  ...
  Widget _buildHeader(double height, SignTheme loginTheme) {
    return _Header(
  ...
  ThemeData _mergeTheme(
      {required ThemeData theme, required SignTheme loginTheme}) {
  ...
  @override
  Widget build(BuildContext context) {
    final loginTheme = widget.theme ?? SignTheme();
    ...
    final emailValidator =
        widget.emailValidator ?? FlutSign.defaultEmailValidator;
    final usernameValidator =
        widget.usernameValidator ?? FlutSign.defaultUsernameValidator;
    final passwordValidator =
        widget.passwordValidator ?? FlutSign.defaultPasswordValidator;
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider.value(
          value: widget.messages ?? SignMessages(),
        ),
        ChangeNotifierProvider.value(
          value: widget.theme ?? SignTheme(),
        ),
